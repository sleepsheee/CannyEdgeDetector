...
//Added by Lu Shi for multi-thread 
...
void *blur_y(void *arguments)
{
   ...
   ****************************************************************************/
   struct thread_args_y *args_y = arguments; 
	
   //unsigned char *image = args->image;
   int rows = args_y->rows;
   int cols = args_y->cols;
   int row_s = args_y->row_s;
   int row_e = args_y->row_e;
   int center = args_y->center;
   float *kernel = args_y->kernel;
   float *tempim = args_y->tempim;
   short int **smoothedim = args_y->smoothedim;
...
//Edited by Lu Shi for multi-thread 
#define N_T 4
/*******************************************************************************
